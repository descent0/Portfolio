  ...
  <div className="absolute inset-y-0 left-0 w-full md:min-w-[calc(fit-8px)] md:w-[calc(100%-8px)] bg-gradient-to-br from-[#4d5361] to-[#000000] flex items-center justify-center px-8 md:pr-[10%] md:[clip-path:polygon(0%_0%,_81%_0%,_100%_50%,_81%_100%,_0%_100%)]">
    ...
    <div className="max-w-[600px]">
      ...
      <p className="text-2xl text-gray-200 mb-12 leading-relaxed font-light" style={{fontFamily: 'Cinzel, serif'}}>
        I BUILD SYSTEMS,<br />NOT JUST CODE
      </p>
      
      {/* Social Icons */}
      <div className="flex gap-6 mb-12">
        {/* LinkedIn */}
        <a href="https://linkedin.com/in/dishant-rajput" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-gray-200 hover:scale-110">
        ...
        {/* GitHub */}
        <a href="https://github.com/dishant-rajput" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-gray-200 hover:scale-110">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#000000">
        ...
        {/* Email */}
        <a href="mailto:dishant.rajput@example.com" className="w-12 h-12 bg-white rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-gray-200 hover:scale-110">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#000000">
      ...
      <div className="hidden md:flex flex-1 flex-col p-8 relative z-[1]">
        ...
        <div className="flex-1 flex items-center justify-center gap-8 relative p-8">
          <div className="bg-gray-800 rounded-[20px] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.4)] transition-transform duration-300 max-w-[300px] z-[2] -mt-12 hover:-translate-y-3">
            <img src="/portfolio.png" alt="Project showcase" className="w-full h-auto rounded-[10px] block" />
          </div>
          <div className="bg-gray-800 rounded-[20px] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.4)] transition-transform duration-300 max-w-[300px] mt-12 hover:-translate-y-3">
            <img src="/finance.png" alt="Project showcase" className="w-full h-auto rounded-[10px] block" />
          </div>
        </div>
