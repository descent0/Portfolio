...
<div className="relative h-screen w-full md:w-[50%] md:min-w-fit bg-white md:[clip-path:polygon(0%_0%,_82%_0%,_100%_50%,_82%_100%,_0%_100%)] z-[2]">
  ...
  <div className="absolute inset-y-0 left-0 w-full md:min-w-[calc(fit-8px)] md:w-[calc(100%-8px)] bg-gradient-to-br from-[#4d5361] to-[#000000] flex items-center justify-center px-4 sm:px-8 md:pr-[10%] md:[clip-path:polygon(0%_0%,_81%_0%,_100%_50%,_81%_100%,_0%_100%)]">
    
    <div className="max-w-[600px] w-full">
      <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-4 sm:mb-6 tracking-tight" style={{fontFamily: 'Cinzel, serif'}}>
      ...
      <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-6 sm:mb-8 md:mb-12 leading-relaxed font-light" style={{fontFamily: 'Cinzel, serif'}}>
      ...
      <div className="flex gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8 md:mb-12">
        {/* LinkedIn */}
        <a href="https://linkedin.com/in/dishant0" target="_blank" rel="noopener noreferrer" className="group w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-gray-200 hover:scale-110 hover:rotate-6 hover:shadow-2xl hover:shadow-blue-500/50">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="#000000">
            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
          </svg>
        </a>
        
        {/* GitHub */}
        <a href="https://github.com/descent0" target="_blank" rel="noopener noreferrer" className="group w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-gray-200 hover:scale-110 hover:-rotate-6 hover:shadow-2xl hover:shadow-purple-500/50">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="#000000">
        ...
        {/* Email */}
        <a href="mailto:rajputdishant891@gmail.com" className="group w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-lg flex items-center justify-center transition-all duration-300 hover:bg-gray-200 hover:scale-110 hover:rotate-6 hover:shadow-2xl hover:shadow-green-500/50">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="#000000">
      ...
      <div className="flex gap-3 sm:gap-4 flex-wrap">
        ...
        <button className="px-6 sm:px-8 md:px-10 py-3 sm:py-4 text-sm sm:text-base md:text-lg rounded-full border-2 border-white cursor-pointer transition-all duration-300 font-medium tracking-wide bg-transparent text-white hover:bg-white hover:text-gray-700">
          View Resume
        </button>
        </Link>
        <Link  href={"mailto:rajputdishant891@gmail.com"}>
        <button className="px-6 sm:px-8 md:px-10 py-3 sm:py-4 text-sm sm:text-base md:text-lg rounded-full border-2 border-white cursor-pointer transition-all duration-300 font-medium tracking-wide bg-white text-gray-700 hover:bg-transparent hover:text-white">
          Connect
        </button>
        </Link>
      </div>
