...
export default function Navigation() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <img src="/fav.png" className="h-10 w-20" alt="PortFolio" />
          </div>
  ...
  <a href="https://github.com/descent0" target="_blank" rel="noopener noreferrer">
    <Button className="cursor-pointer" variant="ghost" size="icon">
      <Github className="h-5 w-5" />
    </Button>
  </a>
  <a href="https://linkedin.com/in/dishant0" target="_blank" rel="noopener noreferrer">
    <Button className="cursor-pointer" variant="ghost" size="icon">
      <Linkedin className="h-5 w-5" />
    </Button>
  </a>
  <a href="mailto:rajputdishant891@gmail.com?subject=Hello&body=Hi%20there!">
    <Button className="cursor-pointer" variant="ghost" size="icon">
